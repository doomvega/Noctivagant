...
[ "posts/2026-01-01-Instantiate-Change.html", "" ],
[ "posts/2025-10-02-We-Did-It.html", "" ],
[ "posts/2025-07-01-If-I-Die.html", "" ],
[ "posts/2025-03-25-Trans-Hope.html", "" ],
[ "posts/2025-02-09-More-Than-a-Game-Balatro.html", encodeURI("More Than a Game— Balatro"), "" ],
[ "posts/2025-02-04-Remote-Editing-and-the-Simplicity-of-Webmastery.html", "" ],
[ "posts/2025-01-18-Pruning-and-Changing.html", "" ],
[ "posts/2024-10-16-A-Long-Day-of-Webdev.html", "" ],
[ "posts/2024-09-28-Post-Bread.html", "" ]
];
...
let headerHTML = '<a class="navButton" href="' + relativePath + '/landing.html">Blog Home</a>' + 
'<a class="navButton" href="' + relativePath + '/archive.html">Archive</a>' +
'<a class="navButton" href="' + relativePath + '/about.html">About</a>' +
'<a class="navButton" href="/index.html">Main Site</a>';
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='mailto:doomvega@noctivagant.net'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://neocities.org/'>Neocities!</a></p>";
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a href="' + relativePath + '/landing.html">Home</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/landing.html">Home</a> | <a href="'+ relativePath + '/' + prevlink +'">Previous Post \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/landing.html">Home</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/landing.html">Home</a> | <a href="' + relativePath + '/'+ prevlink +'">Previous Post \u00BB</a>';
}
